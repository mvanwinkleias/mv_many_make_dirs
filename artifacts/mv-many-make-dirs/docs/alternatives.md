...
update-alternatives --install \
	/usr/bin/mv-many-make-dirs_hello \
	mv-many-make-dirs_hello \
	/opt/IAS/bin/mv-many-make-dirs/mv-many-make-dirs_hello.sh 50
```
...
update-alternatives --remove \
	mv-many-make-dirs_hello \
	/opt/IAS/bin/mv-many-make-dirs/mv-many-make-dirs_hello.sh
```
